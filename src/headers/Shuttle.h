...
class Menu
{
	public:
		...
		// virtual void passengerMenu(int);
		~Menu();
	private:
		Menu *menu;
...
class Validation
{
	public:
		...
		int RCNoValidation(string);	//10Characters - string		
		...
		int bookedSeatsValidation(int,int);
